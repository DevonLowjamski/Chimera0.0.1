...
using BreedingCompatibility = ProjectChimera.Systems.Genetics.BreedingCompatibility;
...
namespace ProjectChimera.UI
{
    ...
    public class BreedingUI : MonoBehaviour
    {
        ...
        private void OnAnalyzeCompatibilityClicked()
        {
            ...
            _currentCompatibility = _breedingSimulator.AnalyzeCompatibility(_selectedParent1, _selectedParent2);
            UpdateUI();
