...
namespace ProjectChimera.Data.Genetics
{
    ...
    public class AlleleSO : ChimeraScriptableObjectSO
    {
        ...
        public float CalculateTraitEffect(TraitType trait, ProjectChimera.Data.Environment.EnvironmentalConditions environment = default)
        {
        ...
        /// </summary>
        private float CalculateEnvironmentalEffect(ProjectChimera.Data.Environment.EnvironmentalConditions environment)
        {
            float modifier = 1f;
        ...
        private float GetEnvironmentalFactorValue(ProjectChimera.Data.Environment.EnvironmentalConditions environment, EnvironmentalFactor factor)
        {
            switch (factor)
            {
        ...
        /// </summary>
        public float CalculateFitness(ProjectChimera.Data.Environment.EnvironmentalConditions environment)
        {
            float fitness = 1f;
