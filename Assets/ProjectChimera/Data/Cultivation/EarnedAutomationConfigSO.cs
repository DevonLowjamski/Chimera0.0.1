...
namespace ProjectChimera.Data.Cultivation
{
    ...
    public class EarnedAutomationConfigSO : ChimeraConfigSO
    {
        ...
        [Header("Task Frequency Thresholds")]
        [Range(1.0f, 20.0f)] public float HighFrequencyThreshold = 5.0f;
        [Range(10.0f, 180.0f)] public float LongTaskTimeThreshold = 60.0f;
        [Range(0.1f, 5.0f)] public float HighVolumeThreshold = 2.0f;
