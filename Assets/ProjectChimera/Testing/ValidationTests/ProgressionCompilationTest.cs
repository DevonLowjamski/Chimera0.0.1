...
namespace ProjectChimera
{
    ...
    public class ProgressionCompilationTest : MonoBehaviour
    {
        void Start()
        {
            ...
            // var progressionManager = GetComponent<ProgressionManager>(); // Class doesn't exist yet
            ...
            // var cleanManager = GetComponent<CleanProgressionManager>(); // Class doesn't exist yet
