...
namespace ProjectChimera.Testing.Data
{
    ...
    public class UnicodeJsonTests
    {
        ...
        public void Test_UnicodeDetection_InvalidHighSurrogate()
        {
            ...
            string invalidText = "Test\uD800Invalid";
        ...
        public void Test_UnicodeDetection_OrphanedLowSurrogate()
        {
            ...
            string invalidText = "Test\uDC00Orphaned";
        ...
        public void Test_JsonHelper_SafeSerialization()
        {
            ...
            {
                Name = "Test\uD800Invalid", // Invalid Unicode
                Description = "Valid description",
                Tags = new List<string> { "Tag1", "Test\uDC00Orphaned" }, // Invalid Unicode in list
                Properties = new Dictionary<string, string>
                {
                    { "Key1", "Valid value" },
                    { "Key2", "Test\uD800\uDC00Valid" } // Valid surrogate pair
                }
            };
        ...
        {
            // Arrange
            string jsonWithUnicodeIssues = @"{""Name"":""Test\uD800Invalid"",""Description"":""Valid""}";
        ...
        public void Test_ObjectScanning_DetectsIssues()
        {
            ...
            var testObject = new TestDataWithUnicode
            {
                Name = "Test\uD800Invalid",
                Description = "Valid description",
                Tags = new List<string> { "Valid", "Test\uDC00Orphaned" }
            };
            ...
            Assert.GreaterOrEqual(report.IssueCount, 2, "Should detect at least 2 issues");
        }
        ...
        public void Test_GeneticData_UnicodeHandling()
        {
            ...
            {
                StrainName = "Test\uD800Strain", // Invalid Unicode
                GenotypeId = "GENO_001",
                StrainId = "Valid ID"
            };
