...
namespace ProjectChimera.Editor.SceneSetup
{
    ...
    public static class EnhancedGameSceneBuilder
    {
        ...
        private static GameObject CreateFullGameManagerSystem()
        {
            ...
            // gameManagerGO.AddComponent<SaveManager>(); // SaveManager doesn't exist yet
            ...
            // gameManagerGO.AddComponent<ProgressionManager>(); // ProgressionManager doesn't exist yet
        ...
        private static GameObject CreateFunctionalUISystem()
        {
            ...
            // Add MainGameUIController (disabled - was using legacy UI)
            ...
            Debug.Log("Functional UI system created (MainGameUIController disabled due to legacy UI)");
            return canvasGO;
        }
            ...
            GameObject lightingSystem, GameObject environment, GameObject uiSystem, GameObject cultivation)
        {
            ...
            // var uiController = uiSystem.GetComponent<MainGameUIController>(); // Disabled - legacy UI
            ...
            Debug.Log("UI Controller disabled (MainGameUIController used legacy UI components)");
