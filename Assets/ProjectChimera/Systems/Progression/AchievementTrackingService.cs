...
namespace ProjectChimera.Systems.Progression
{
    ...
    public class AchievementTrackingService : MonoBehaviour, IAchievementTrackingService
    {
        ...
        [SerializeField] private List<AchievementProgress> _playerProgress = new List<AchievementProgress>();

        // Service state
        private bool _isInitialized = false;
        private Dictionary<string, Achievement> _achievementLookup = new Dictionary<string, Achievement>();
        private Dictionary<string, List<AchievementProgress>> _playerProgressLookup = new Dictionary<string, List<AchievementProgress>>();
        ...
        public event Action<string, AchievementProgress> OnAchievementUnlocked;
        ...
        public IReadOnlyList<AchievementProgress> PlayerProgress => _playerProgress;
        ...
        private void InitializeDataStructures()
        {
            ...
            _playerProgress = new List<AchievementProgress>();
            _achievementLookup = new Dictionary<string, Achievement>();
            _playerProgressLookup = new Dictionary<string, List<AchievementProgress>>();
        ...
        private void BuildLookupTables()
        {
            ...
            foreach (var progress in _playerProgress)
            {
                ...
                {
                    _playerProgressLookup[progress.PlayerId] = new List<AchievementProgress>();
                }
        ...
        {
            return new List<AchievementProgress>(_playerProgress);
        }
        ...
        private AchievementProgress GetOrCreateProgress(string achievementId, string playerId)
        {
            ...
            {
                _playerProgressLookup[playerId] = new List<AchievementProgress>();
            }
        ...
        public List<AchievementProgress> GetPlayerProgress(string playerId)
        {
