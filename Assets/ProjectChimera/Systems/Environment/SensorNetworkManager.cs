...
namespace ProjectChimera.Systems.Environment
{
    ...
    public class SensorNetworkManager : MonoBehaviour, IEnvironmentalService
    {
        ...
        // Events
        public System.Action<string, SensorReading> OnSensorDataReceived;
        ...
        public EnvironmentalConditions ReadZoneConditions(string zoneId)
        {
            ...
            {
                var reading = GenerateSensorReading(sensor, conditions);
        ...
        public bool CalibrateSensor(string sensorId, EnvironmentalConditions referenceConditions)
        {
            ...
            var currentReading = GenerateSensorReading(sensor, referenceConditions);
        ...
        /// </summary>
        private SensorReading GenerateSensorReading(EnvironmentalSensorData sensor, EnvironmentalConditions actualConditions)
        {
        ...
        /// </summary>
        private void RecordSensorReading(string sensorId, SensorReading reading)
        {
        ...
        /// </summary>
        private float CalculateCalibrationDrift(SensorReading sensorReading, EnvironmentalConditions reference)
        {
            float totalDrift = 0f;
            int measurements = 0;
    ...
    {
        [SerializeField] private List<SensorReading> _readings = new List<SensorReading>();
