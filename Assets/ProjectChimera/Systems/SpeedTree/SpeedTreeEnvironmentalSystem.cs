...
namespace ProjectChimera.Systems.SpeedTree
{
    ...
    public class SpeedTreeEnvironmentalSystem : ChimeraManager
    {
        ...
        private void ApplyMorphologicalResponse(SpeedTreePlantData instance, EnvironmentalResponse response)
        {
#if UNITY_SPEEDTREE
        ...
        private void ApplyAnimationResponse(SpeedTreePlantData instance, EnvironmentalResponse response)
        {
#if UNITY_SPEEDTREE
            if (instance.Renderer?.materialProperties == null) return;
        ...
        private void ApplyGeneticAdaptation(SpeedTreePlantData instance, string adaptationType, float strength)
        {
        ...
        private void ApplyToleranceImprovement(SpeedTreePlantData instance, string toleranceType, float improvement)
        {
            // These would modify the plant's response curves
            instance.EnvironmentalModifiers[$"tolerance_{toleranceType}"] = 1f + improvement;
        }
        
        private void ApplyEfficiencyImprovement(SpeedTreePlantData instance, string efficiencyType, float improvement)
        {
        ...
        private void HandlePlantStageChanged(SpeedTreePlantData instance, PlantGrowthStage newStage)
        {
