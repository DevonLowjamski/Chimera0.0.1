...
namespace ProjectChimera.Systems.SpeedTree
{
    ...
    public class PlantGrowthState
    {
        ...
        public SpeedTreePlantData PlantInstance;
    ...
    public class GrowthMilestone
    {
        ...
        // Static milestone definitions for compatibility
        public static GrowthMilestone FirstLeaves => new GrowthMilestone { Id = "first_leaves", Name = "First Leaves", ProgressThreshold = 0.25f };
        public static GrowthMilestone StructuralDevelopment => new GrowthMilestone { Id = "structural_dev", Name = "Structural Development", ProgressThreshold = 0.5f };
        public static GrowthMilestone FloweringOnset => new GrowthMilestone { Id = "flowering_onset", Name = "Flowering Onset", ProgressThreshold = 0.75f };
        public static GrowthMilestone MaturationComplete => new GrowthMilestone { Id = "maturation", Name = "Maturation Complete", ProgressThreshold = 1.0f };
        public static GrowthMilestone FullMaturity => new GrowthMilestone { Id = "full_maturity", Name = "Full Maturity", ProgressThreshold = 1.0f };
    ...
    public class MorphologicalProgressionManager
    {
        ...
        public void UpdatePlantSize(SpeedTreePlantData instance, float growthProgress)
        {
        ...
        public void UpdatePlantMorphology(SpeedTreePlantData instance, PlantGrowthStage stage, float stageProgress)
        {
            if (!_enabled) return;
        ...
        private Vector3 CalculateTargetSize(SpeedTreePlantData instance, float progress)
        {
    ...
    public class ColorProgressionManager
    {
        ...
        public void UpdatePlantColors(SpeedTreePlantData instance, PlantGrowthStage stage, float stageProgress)
        {
            if (!_enabled) return;
        ...
        public void ApplySeasonalColoring(SpeedTreePlantData instance, SeasonType season)
        {
            if (!_enabled) return;
    ...
    public class BudDevelopmentSystem
    {
        ...
        public void InitializeBudGrowth(SpeedTreePlantData instance)
        {
        ...
        public BudDevelopmentData UpdateBudGrowth(SpeedTreePlantData instance, float deltaTime)
        {
        ...
        public void ActivateBudGrowth(SpeedTreePlantData instance)
        {
            if (_budData.TryGetValue(instance.InstanceId, out var budData))
            {
        ...
        public void FinalizebudDevelopment(SpeedTreePlantData instance)
        {
            if (_budData.TryGetValue(instance.InstanceId, out var budData))
            {
        ...
        private float CalculateBudGrowthRate(SpeedTreePlantData instance)
        {
            var baseRate = 0.1f;
        ...
        public void UpdateVisualBudDevelopment(SpeedTreePlantData instance, float growthProgress)
        {
            if (_budData.TryGetValue(instance.InstanceId, out var budData))
            {
    ...
    public class TrichromeGrowthSystem
    {
        ...
        public void InitializeTrichromeGrowth(SpeedTreePlantData instance)
        {
        ...
        public TrichromeData UpdateTrichromeGrowth(SpeedTreePlantData instance, float deltaTime)
        {
        ...
        public void ActivateTrichromeGrowth(SpeedTreePlantData instance)
        {
            if (_trichromeData.TryGetValue(instance.InstanceId, out var trichromeData))
            {
        ...
        public void MaximizeTrichromeProduction(SpeedTreePlantData instance)
        {
            if (_trichromeData.TryGetValue(instance.InstanceId, out var trichromeData))
            {
        ...
        private float CalculateTrichromeGrowthRate(SpeedTreePlantData instance)
        {
            var baseRate = 0.05f;
        ...
        public void UpdateTrichromeVisualization(SpeedTreePlantData instance, float growthProgress)
        {
            if (_trichromeData.TryGetValue(instance.InstanceId, out var trichromeData))
            {
    ...
    public class RootGrowthSimulator
    {
        ...
        public void InitializeRootSystem(SpeedTreePlantData instance)
        {
        ...
        public void UpdateRootGrowth(SpeedTreePlantData instance, float deltaTime)
        {
        ...
        private float CalculateRootGrowthRate(SpeedTreePlantData instance)
        {
            var baseRate = 0.1f;
        ...
        public void UpdateRootVisualization(SpeedTreePlantData instance)
        {
    ...
    public class CanopyDevelopmentManager
    {
        ...
        public void UpdateCanopyGrowth(SpeedTreePlantData instance, float deltaTime)
        {
        ...
        private float CalculateCanopyGrowthRate(SpeedTreePlantData instance)
        {
            var baseRate = 0.05f;
        ...
        public void UpdateCanopyVisualization(SpeedTreePlantData instance)
        {
            if (_canopyData.TryGetValue(instance.InstanceId, out var canopyData))
            {
