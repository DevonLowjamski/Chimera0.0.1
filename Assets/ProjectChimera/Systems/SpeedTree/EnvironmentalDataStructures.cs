...
namespace ProjectChimera.Systems.SpeedTree
{
    ...
    public class StressVisualizationManager
    {
        ...
        public void UpdateStressVisualization(SpeedTreePlantData instance, EnvironmentalStressData stressData)
        {
        ...
        public void UpdatePlantVisualization(SpeedTreePlantData instance, EnvironmentalStressData stressData)
        {
#if UNITY_SPEEDTREE
