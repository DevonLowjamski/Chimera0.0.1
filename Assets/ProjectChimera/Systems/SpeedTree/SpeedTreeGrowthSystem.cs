...
namespace ProjectChimera.Systems.SpeedTree
{
    ...
    public class SpeedTreeGrowthSystem : ChimeraManager
    {
        ...
        public void RegisterPlantForGrowth(SpeedTreePlantData instance)
        {
        ...
        private float CalculateInitialGrowthRate(SpeedTreePlantData instance)
        {
            var baseRate = 1f;
        ...
        private Vector3 CalculateTargetSize(SpeedTreePlantData instance)
        {
        ...
        private DateTime CalculateEstimatedHarvestTime(SpeedTreePlantData instance)
        {
        ...
        private Dictionary<string, float> ExtractGeneticModifiers(SpeedTreePlantData instance)
        {
        ...
        private void UpdateSizeAnimation(SpeedTreePlantData instance, GrowthAnimationData animationData, float progress)
        {
        ...
        private void UpdateMorphologyAnimation(SpeedTreePlantData instance, GrowthAnimationData animationData, float progress)
        {
#if UNITY_SPEEDTREE
        ...
        private void UpdateWindAnimation(SpeedTreePlantData instance, GrowthAnimationData animationData)
        {
#if UNITY_SPEEDTREE
            if (instance.Renderer?.materialProperties == null) return;
        ...
        private void UpdateSpecializedVisualElements(SpeedTreePlantData instance, PlantGrowthState growthState)
        {
        ...
        private EnvironmentalConditions GetCurrentEnvironmentalConditions(SpeedTreePlantData instance)
        {
            if (_environmentalManager != null)
            {
        ...
        private void HandlePlantInstanceDestroyed(SpeedTreePlantData instance)
        {
