...
namespace ProjectChimera.Systems.SpeedTree
{
    ...
    public class SpeedTreePlantInstance : MonoBehaviour
    {
        ...
        // Type conversion methods for compatibility with SpeedTreePlantData
        public SpeedTreePlantData ToSpeedTreePlantData()
        {
            var data = new SpeedTreePlantData
            {
        ...
        public void UpdateFromSpeedTreePlantData(SpeedTreePlantData data)
        {
            if (data == null) return;
