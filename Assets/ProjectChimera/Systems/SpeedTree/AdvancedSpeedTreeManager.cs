...
// Explicit alias for LightingConditions to resolve namespace conflicts
using SystemsLightingConditions = ProjectChimera.Systems.Environment.LightingConditions;
...
namespace ProjectChimera.Systems.SpeedTree
{
    ...
    public class AdvancedSpeedTreeManager : ChimeraManager
    {
        ...
        [SerializeField] private SpeedTreeQualityLevel _defaultQuality = new SpeedTreeQualityLevel { QualityName = "High", QualityLevel = 3 };
        ...
        // Static properties for accessing quality levels - removed to fix CS0120 error
        ...
        // SpeedTreePlantData class removed - using the one from SpeedTreeDataStructures.cs
        ...
        private void InitializeCannabisSimulation()
        {
            ...
            _geneticsProcessor = new CannabisGeneticsProcessor("genetics_processor");
            _growthAnimator = new CannabisGrowthAnimator("growth_animator");
            _environmentalProcessor = new CannabisEnvironmentalProcessor("environmental_processor");
            _stressVisualizer = new CannabisStressVisualizer("stress_visualizer");
        ...
        private ProjectChimera.Systems.SpeedTree.SpeedTreeRenderer CreateSpeedTreeRenderer(SpeedTreePlantData instance)
        {
#if UNITY_SPEEDTREE
            ...
            var speedTreeRenderer = rendererGO.AddComponent<SpeedTree.SpeedTreeRenderer>();
            speedTreeRenderer.speedTreeAsset = speedTreeAsset;
            
            // Create our wrapper renderer
            var renderer = rendererGO.AddComponent<ProjectChimera.Systems.SpeedTree.SpeedTreeRenderer>();
        ...
        private void ReduceQuality()
        {
            if (_performanceMetrics.QualityLevel > SpeedTreeQualityLevel.Low)
            {
                ...
                if (currentLevel > 1)
                {
                    _performanceMetrics.QualityLevel = new SpeedTreeQualityLevel 
                    { 
        ...
        private void HandleLightingChange(SystemsLightingConditions lightingConditions)
        {
    ...
    // Missing type definitions for AdvancedSpeedTreeManager
    [System.Serializable]
    public class SpeedTreePerformanceMetrics
    {
        ...
        // Missing methods from SpeedTreeGrowthConfigSO reference
        public object GetStageConfiguration(PlantGrowthStage stage)
        {
            return new { SizeMultiplier = 1f };
        }
        
        // Missing properties
        public int MaxVisiblePlants = 1000;
        public float CullingDistance = 500f;
        public SpeedTreeQualityLevel QualityLevel = new SpeedTreeQualityLevel();
        public bool GPUInstancingEnabled = true;
        public bool DynamicBatchingEnabled = true;
        public float FrameRate = 60f;
        public int VisiblePlants = 0;
    ...
    public class SpeedTreeSystemReport
    {
        ...
        public Dictionary<string, bool> ActiveSystemsStatus = new Dictionary<string, bool>();
    }
    ...
    public class CannabisGeneticsProcessor
    {
        ...
        public CannabisGeneticsProcessor(string processorId)
        {
            ProcessorId = processorId;
        }
        
        public void ProcessGenetics(CannabisGeneticData genetics)
        {
    ...
    // Additional missing type definitions for AdvancedSpeedTreeManager
    [System.Serializable]
    public class CannabisGrowthAnimator
    {
        ...
        public CannabisGrowthAnimator(string animatorId)
        {
            AnimatorId = animatorId;
        }
        
        public void InitializePlant(SpeedTreePlantData instance) { }
        public void UpdatePlantGrowth(SpeedTreePlantData instance, float deltaTime) { }
        public void AnimateStageTransition(SpeedTreePlantData instance, PlantGrowthStage oldStage, PlantGrowthStage newStage) { }
        public void RemovePlant(SpeedTreePlantData instance) { }
        public void Update() { }
        public void Cleanup() { }
    }
    ...
    public class CannabisEnvironmentalProcessor
    {
        ...
        public CannabisEnvironmentalProcessor(string processorId)
        {
            ProcessorId = processorId;
        }
        
        public void ApplyEnvironmentalConditions(SpeedTreePlantData instance, DataEnvironmentalConditions conditions) { }
        public void UpdateEnvironmentalResponse(SpeedTreePlantData instance, DataEnvironmentalConditions conditions) { }
        public void Update() { }
        public void Cleanup() { }
    }
    ...
    public class CannabisStressVisualizer
    {
        ...
        public CannabisStressVisualizer(string visualizerId)
        {
            VisualizerId = visualizerId;
        }
        
        public void UpdateStressVisualization(SpeedTreePlantData instance) { }
        public void UpdateHealthVisualization(SpeedTreePlantData instance, float health) { }
        public void Update() { }
        public void Cleanup() { }
    }
    ...
    public class SpeedTreeLODManager
    {
        ...
        public SpeedTreeLODManager(SpeedTreeLODConfigSO config)
        {
            ManagerId = "lod_manager";
        }
        
        public void ConfigureRenderer(SpeedTreeRenderer renderer, SpeedTreePlantData instance) { }
        public void UpdateLODs(List<SpeedTreePlantData> instances) { }
        public void ApplyQualitySettings(SpeedTreeRenderer renderer, SpeedTreeQualityLevel quality) { }
        public void Update() { }
        public void Cleanup() { }
    }
    ...
    public class SpeedTreeBatchingManager
    {
        ...
        public int CurrentBatchCount = 0;
        public int EstimatedDrawCalls = 0;
        
        public SpeedTreeBatchingManager(bool dynamicBatching, bool gpuInstancing)
        {
            ManagerId = "batching_manager";
        }
        
        public void RegisterRenderer(SpeedTreeRenderer renderer) { }
        public void UnregisterRenderer(SpeedTreeRenderer renderer) { }
    ...
    public class SpeedTreeCullingManager
    {
        ...
        public bool IsActive = true;
        public float CullingDistance = 500f;
        public int VisiblePlantCount = 0;
        
        public SpeedTreeCullingManager(float cullingDistance)
        {
            ManagerId = "culling_manager";
            CullingDistance = cullingDistance;
        }
        
        public void UpdateLODs(List<SpeedTreePlantData> instances) { }
        public void CullDistantPlants(List<SpeedTreePlantData> instances) { }
        public void Update() { }
        public void Cleanup() { }
    }
    ...
    public class SpeedTreeMemoryManager
    {
        ...
        public SpeedTreeMemoryManager()
        {
            ManagerId = "memory_manager";
        }
    ...
    public class SpeedTreeWindController
    {
        ...
        {
            ControllerId = "wind_controller";
        }
        
        public void ConfigureRenderer(SpeedTreeRenderer renderer, SpeedTreePlantData instance) { }
        public void UpdateWind() { }
        public void ApplyWindSettings(SpeedTreeWindSettings settings) { }
        public void UpdateGlobalWindStrength(float strength) { WindStrength = strength; }
        public void SetEnabled(bool enabled) { IsActive = enabled; }
        public void Cleanup() { }
    }
    
    // Additional missing types
    [System.Serializable]
    public class SpeedTreeQualityLevel
    {
        ...
        // Static quality levels
        public static SpeedTreeQualityLevel Low => new SpeedTreeQualityLevel { QualityName = "Low", QualityLevel = 1 };
        public static SpeedTreeQualityLevel Medium => new SpeedTreeQualityLevel { QualityName = "Medium", QualityLevel = 2 };
        public static SpeedTreeQualityLevel High => new SpeedTreeQualityLevel { QualityName = "High", QualityLevel = 3 };
        public static SpeedTreeQualityLevel Ultra => new SpeedTreeQualityLevel { QualityName = "Ultra", QualityLevel = 4 };
        
        // Comparison operators
        public static bool operator >(SpeedTreeQualityLevel left, SpeedTreeQualityLevel right)
        {
        ...
        public static implicit operator int(SpeedTreeQualityLevel quality)
        {
            return quality?.QualityLevel ?? 0;
        }
    }
    
    // Additional missing data structures - removed duplicates
    // LightingConditions removed - using SystemsLightingConditions alias instead
